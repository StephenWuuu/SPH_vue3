<template>
  <div class="detail">
    ...
    <section class="con">
      <!-- 导航路径区域 -->
      <div class="conPoin">
        <span v-show="detailStore.categoryView.category1Name">{{
          detailStore.categoryView.category1Name
        }}</span>
        <span v-show="detailStore.categoryView.category2Name">{{
          detailStore.categoryView.category2Name
        }}</span>
        <span v-show="detailStore.categoryView.category3Name">{{
          detailStore.categoryView.category3Name
        }}</span>
      </div>
      <!-- 主要内容区域 -->
      <div class="mainCon">
        ...
        <div class="InfoWrap">
          <div class="goodsDetail">
            <h3 class="InfoName">
              {{ detailStore.skuInfo.skuName }}
            </h3>
            <p class="news">
              {{ detailStore.skuInfo.skuDesc }}
            </p>
            <div class="priceArea">
              <div class="priceArea1">
                ...
                <div class="price">
                  <i>¥</i>
                  <em>{{ detailStore.skuInfo.price }}</em>
                  <span>降价通知</span>
                </div>
                <div class="remark">
                  <i>累计评价</i>
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl
                v-for="spuSaleAttr in detailStore.spuSaleAttrList"
                :key="spuSaleAttr.id"
              >
                <dt class="title">
...
const skuNum = ref(1);
onMounted(() => {
  detailStore.getDetailInfo(route.params.skuId);
});
