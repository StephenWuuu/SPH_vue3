      ...
      <div class="title clearfix">
        ...
        <div class="fr">
          <ul
            ...
            v-for="item in store.floorLists[0].navList"
            :key="item"
          >
            <li class="active">
      ...
      <div class="tab-content">
        <div class="tab-pane">
          <div class="floor-1">
            <div class="blockgary">
              <ul class="jd-list">
                <li v-for="item in store.floorLists[0].keywords">{{ item }}</li>
              </ul>
            ...
            <div class="floorBanner">
              <el-carousel height="360px">
                <el-carousel-item
                  v-for="item in store.floorLists[0].carouselList"
                  :key="item"
                >
                  <img src="./images/floor-1-b01.png" alt="" srcset="" />
                </el-carousel-item>
              </el-carousel>
            </div>
            <div class="split">
